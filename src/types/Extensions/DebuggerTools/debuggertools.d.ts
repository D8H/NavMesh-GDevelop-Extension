declare namespace gdjs {
    namespace evtTools {
        ...
        namespace debuggerTools {
             ...
             */
            const enableDebugDraw: (instanceContainer: gdjs.RuntimeInstanceContainer, enableDebugDraw: boolean, showHiddenInstances: boolean, showPointsNames: boolean, showCustomPoints: boolean, showCollisionMasks: boolean, showPositions: boolean) => void;
        }
    }
}
