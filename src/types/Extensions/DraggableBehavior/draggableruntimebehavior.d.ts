declare namespace gdjs {
    ...
    abstract class DraggableManager {
         ...
         */
        static getMouseManager(instanceContainer: gdjs.RuntimeInstanceContainer): MouseDraggableManager;
        /**
         * Get the platforms manager of an instance container.
         */
        ...
        abstract shouldEndDrag(instanceContainer: gdjs.RuntimeInstanceContainer, draggableRuntimeBehavior: DraggableRuntimeBehavior): boolean;
        abstract getPosition(instanceContainer: gdjs.RuntimeInstanceContainer, draggableRuntimeBehavior: DraggableRuntimeBehavior): FloatPoint;
    }
    /**
