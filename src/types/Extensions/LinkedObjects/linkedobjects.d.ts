declare namespace gdjs {
    ...
    namespace evtTools {
        namespace linkedObjects {
            const linkObjects: (instanceContainer: gdjs.RuntimeInstanceContainer, objA: gdjs.RuntimeObject, objB: gdjs.RuntimeObject) => void;
            const removeLinkBetween: (instanceContainer: gdjs.RuntimeInstanceContainer, objA: gdjs.RuntimeObject, objB: gdjs.RuntimeObject) => void;
            const removeAllLinksOf: (instanceContainer: gdjs.RuntimeInstanceContainer, objA: gdjs.RuntimeObject) => void;
            const pickObjectsLinkedTo: (instanceContainer: gdjs.RuntimeInstanceContainer, objectsLists: Hashtable<gdjs.RuntimeObject[]>, obj: gdjs.RuntimeObject, eventsFunctionContext: EventsFunctionContext | undefined) => boolean;
        }
    }
}
