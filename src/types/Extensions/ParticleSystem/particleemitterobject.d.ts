declare namespace gdjs {
    ...
    class ParticleEmitterObject extends gdjs.RuntimeObject {
         ...
         */
        constructor(instanceContainer: gdjs.RuntimeInstanceContainer, particleObjectData: ParticleEmitterObjectData);
        setX(x: number): void;
        setY(y: number): void;
        setAngle(angle: any): void;
        getRendererObject(): any;
        updateFromObjectData(oldObjectData: ParticleEmitterObjectData, newObjectData: ParticleEmitterObjectData): boolean;
        ...
        getTexture(): string;
        setTexture(texture: string, instanceContainer: gdjs.RuntimeInstanceContainer): void;
    }
}
