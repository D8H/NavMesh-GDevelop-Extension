declare namespace gdjs {
    namespace playerAuthenticationComponents {
         ...
         */
        const addAuthenticationTextsToLoadingContainer: (loaderContainer: HTMLDivElement, platform: any, isGameRegistered: any) => HTMLDivElement;
        /**
         ...
         */
        const addTouchAndClickEventListeners: (element: HTMLElement, action: () => void) => void;
    }
}
