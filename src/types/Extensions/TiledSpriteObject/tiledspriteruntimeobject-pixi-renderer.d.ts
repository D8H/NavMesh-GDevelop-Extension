declare namespace gdjs {
    ...
    class TiledSpriteRuntimeObjectPixiRenderer {
        ...
        constructor(runtimeObject: gdjs.TiledSpriteRuntimeObject, instanceContainer: gdjs.RuntimeInstanceContainer, textureName: string);
        getRendererObject(): PIXI.TilingSprite;
        updateOpacity(): void;
        updatePosition(): void;
        setTexture(textureName: string, instanceContainer: RuntimeInstanceContainer): void;
        updateAngle(): void;
        getWidth(): float;
        getHeight(): float;
