declare namespace gdjs {
    ...
    abstract class RuntimeInstanceContainer {
        ...
        _debugDrawShowCollisionMasks: boolean;
        _debugDrawShowPositions: boolean;
        constructor();
        /**
         ...
         */
        enableDebugDraw(enableDebugDraw: boolean, showHiddenInstances: boolean, showPointsNames: boolean, showCustomPoints: boolean, showCollisionMasks: boolean, showPositions: boolean): void;
        /**
