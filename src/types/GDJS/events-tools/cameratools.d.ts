declare namespace gdjs {
  namespace evtTools {
    namespace camera {
      ...
      const getCameraBorderLeft: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        cameraId: integer
      ) => number;
      const getCameraBorderRight: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        cameraId: integer
      ) => number;
      const getCameraBorderTop: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        cameraId: integer
      ) => number;
      const getCameraBorderBottom: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        cameraId: integer
      ) => number;
       ...
       */
      const centerCameraWithinLimits: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        object: gdjs.RuntimeObject | null,
        left: number,
        top: number,
       ...
       */
      const setLayerEffectDoubleParameter: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        effect: string,
        parameter: string,
       ...
       * @param value The new value
       */
      const setLayerEffectStringParameter: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        effect: string,
        parameter: string,
       ...
       * @param value The new value
       */
      const setLayerEffectBooleanParameter: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        effect: string,
        parameter: string,
       ...
       */
      const layerEffectEnabled: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        effect: string
      ) => boolean;
      const setLayerTimeScale: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        timeScale: float
      ) => void;
      const getLayerTimeScale: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string
      ) => number;
      const setLayerDefaultZOrder: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string,
        defaultZOrder: integer
      ) => void;
      const getLayerDefaultZOrder: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layer: string
      ) => number;
      /**
       ...
       */
      const setLayerAmbientLightColor: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        layerName: string,
        rgbColor: string
      ) => void;
