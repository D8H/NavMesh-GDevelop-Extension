declare namespace gdjs {
  namespace evtTools {
    namespace input {
      ...
      const _cursorIsOnObject: (
        obj: gdjs.RuntimeObject,
        instanceContainer: gdjs.RuntimeInstanceContainer
      ) => boolean;
      const cursorOnObject: (
      ...
      const hasAnyTouchStarted: (
        instanceContainer: gdjs.RuntimeInstanceContainer
      ) => boolean;
      const getStartedTouchCount: (
        instanceContainer: gdjs.RuntimeInstanceContainer
      ) => integer;
      const getStartedTouchIdentifier: (
        instanceContainer: gdjs.RuntimeInstanceContainer,
        index: integer
      ) => integer;
      const hasTouchEnded: (
