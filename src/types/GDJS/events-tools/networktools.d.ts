declare namespace gdjs {
  namespace evtTools {
    namespace network {
      ...
      const sendAwaitableAsyncRequest: (
        url: string,
        body: string,
        method: string,
        contentType: string,
       ...
       * @deprecated
       */
      const sendDeprecatedSynchronousRequest: (
        host: any,
        uri: any,
        body: any,
        method: any,
       ...
       * @deprecated Use `JSON.stringify(variable.toJSObject())` instead.
       */
      const objectVariableStructureToJSON: (
       ...
       * @deprecated Use `variable.fromJSON` instead.
       */
      const jsonToObjectVariableStructure: (
        jsonStr: string,
        object: gdjs.RuntimeObject,
        variable: gdjs.Variable
      ) => void;
