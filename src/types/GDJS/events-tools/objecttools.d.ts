declare namespace gdjs {
    namespace evtTools {
        namespace object {
             ...
             */
            const doCreateObjectOnScene: (objectsContext: EventsFunctionContext | gdjs.RuntimeScene, objectName: string, objectsLists: ObjectsLists, x: float, y: float, layerName: string) => void;
            /**
             * Allows events to create a new object on a scene.
             */
            const createObjectOnScene: (objectsContext: EventsFunctionContext | gdjs.RuntimeScene, objectsLists: ObjectsLists, x: float, y: float, layerName: string) => void;
            /**
             * Allows events to create a new object on a scene.
             */
