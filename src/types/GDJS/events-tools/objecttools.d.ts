declare namespace gdjs {
  namespace evtTools {
    namespace object {
       ...
       * Allows events to create a new object on a scene.
       */
      const createObjectFromGroupOnScene: (
        objectsContext: EventsFunctionContext | gdjs.RuntimeScene,
        objectsLists: ObjectsLists,
        objectName: string,
        x: float,
