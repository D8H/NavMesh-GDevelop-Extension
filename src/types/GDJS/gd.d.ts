...
declare namespace gdjs {
   ...
   */
  export const registerFirstRuntimeSceneLoadedCallback: (
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeSceneLoadedCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeScenePreEventsCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   * Register a function to be called each time a scene is stepped (i.e: at every frame),
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeScenePostEventsCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeScenePausedCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeSceneResumedCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeSceneUnloadingCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   ...
   * @param callback The function to be called.
   */
  export const registerRuntimeSceneUnloadedCallback: (
    callback: RuntimeSceneCallback
  ) => void;
  /**
   ...
   * @param callback The function to be called.
   */
  export const registerObjectDeletedFromSceneCallback: (
   ...
   */
  export const getObjectConstructor: (
    name: string
   ...
   */
  export const getBehaviorConstructor: (
    name: string
   ...
   * @returns {Array}
   */
  export const objectsListsToArray: (
